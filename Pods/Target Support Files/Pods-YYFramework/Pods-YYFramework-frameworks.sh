...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../flutter_yyframework/.ios/Flutter/engine/Flutter.framework"
  ...
  install_framework "${PODS_ROOT}/../../flutter_yyframework/.ios/Flutter/App.framework"
fi
