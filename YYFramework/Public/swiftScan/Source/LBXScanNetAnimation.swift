...
//           stepAnimation()
    ...
    @objc func newStepAnimation()
    {
        ...
        _ = self.image!.size.height * animationRect.size.width / self.image!.size.width;
        ...
        UIView.animate(withDuration: 1.2, animations: { () -> Void in
            ...
            self.perform(#selector(LBXScanNetAnimation.newStepAnimation), with: nil, afterDelay: 0.3)
