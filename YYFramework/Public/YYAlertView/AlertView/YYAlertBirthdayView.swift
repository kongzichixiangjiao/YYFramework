...
extension UIView: BirthdayProtocol {
    var birthdayView: YYAlertBirthdayView {
        get {
            guard let b: YYAlertBirthdayView = objc_getAssociatedObject(self, &YYAlertKey.kBirthdayView) as? YYAlertBirthdayView else {
                ...
                birthdayView.frame = CGRect(x: 0, y: kScreenHeight, width: kScreenWidth, height: YYAlertBirthdayView.height)
    ...
    func showBirthdayView(_ handler: @escaping DidSelectedHandler) {
        ...
        UIView.animate(withDuration: 0.25) {
            self.birthdayView.frame = CGRect(x: 0, y: kScreenHeight - YYAlertBirthdayView.height, width: kScreenWidth, height: YYAlertBirthdayView.height)
        }
    ...
    func hideBirthdayView() {
        UIView.animate(withDuration: 0.25, animations: { 
            self.birthdayView.frame = CGRect(x: 0, y: kScreenHeight, width: kScreenWidth, height: YYAlertBirthdayView.height)
        }) { (bo) in
